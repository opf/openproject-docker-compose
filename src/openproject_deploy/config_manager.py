...
class ConfigManager:
    ...
    def __init__(self, env_file: Optional[Path] = None, cfg_file: Optional[Path] = None):
        """
        Initialize configuration manager
        
        Args:
            env_file: Path to .env file (defaults to .env in current directory)
            cfg_file: Path to .cfg file (defaults to scripts/installation_scripts/interactive_config.cfg)
        """
        self.env_file = env_file or Path(".env")
        self.cfg_file = cfg_file or Path("scripts/installation_scripts/interactive_config.cfg")
